...
public class Sidebar extends View{
	...
	private void init(){
	    String st = context.getString(com.kind.chat.R.string.search_new);
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN:{
			if(header == null){
				header = (TextView) ((View)getParent()).findViewById(com.kind.chat.R.id.floating_header);
			}
			setHeaderTextAndscroll(event);
			header.setVisibility(View.VISIBLE);
			setBackgroundResource(com.kind.chat.R.drawable.sidebar_background_pressed);
			return true;
		}
