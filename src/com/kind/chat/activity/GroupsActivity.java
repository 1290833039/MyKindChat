...
import com.kind.chat.adapter.GroupAdapter;
...
public class GroupsActivity extends BaseActivity {
					...
					if (success) {
						...
						if (!GroupsActivity.this.isFinishing()) {
							String s1 = getResources()
									.getString(
											com.kind.chat.R.string.Failed_to_get_group_chat_information);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.kind.chat.R.layout.fragment_groups);

		instance = this;
		inputMethodManager = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
		grouplist = EMGroupManager.getInstance().getAllGroups();
		groupListView = (ListView) findViewById(com.kind.chat.R.id.list);
		...
		progressBar = (View)findViewById(com.kind.chat.R.id.progress_bar);
