...
public class OfflinePushNickActivity extends BaseActivity {
	...
	protected void onCreate(Bundle arg0) {
		...
		super.onCreate(arg0);
		setContentView(com.kind.chat.R.layout.activity_offline_push);

		inputNickName = (EditText) findViewById(com.kind.chat.R.id.et_input_nickname);
		saveNickName = (Button) findViewById(com.kind.chat.R.id.btn_save);
		nicknameDescription = (TextView) findViewById(com.kind.chat.R.id.tv_nickname_description);
