...
import com.kind.chat.adapter.ChatHistoryAdapter;
...
public class ChatHistoryFragment extends Fragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		final String st = getResources().getString(com.kind.chat.R.string.Cant_chat_with_yourself);
	 ...
	 */
	public void refresh() {
		adapter = new ChatHistoryAdapter(getActivity(), com.kind.chat.R.layout.row_chat_history, loadUsersWithRecentChat());
		listView.setAdapter(adapter);
		adapter.notifyDataSetChanged();
	}
