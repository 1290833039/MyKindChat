...
public class RobotsActivity extends BaseActivity {
	...
	protected void onCreate(Bundle arg0) {
		super.onCreate(arg0);
		setContentView(com.kind.chat.R.layout.fragment_robots);
		inputMethodManager = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
		mListView = (ListView) findViewById(com.kind.chat.R.id.list);
		swipeRefreshLayout = (SwipeRefreshLayout) findViewById(com.kind.chat.R.id.swipe_layout);
		swipeRefreshLayout.setColorSchemeResources(android.R.color.holo_blue_bright, android.R.color.holo_green_light,
				android.R.color.holo_orange_light, android.R.color.holo_red_light);
		progressBar = findViewById(com.kind.chat.R.id.progress_bar);
	...
	class RobotAdapter extends ArrayAdapter<RobotUser> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			if (convertView == null) {
				convertView = inflater.inflate(com.kind.chat.R.layout.row_robots, null);
			}
			((TextView) convertView.findViewById(com.kind.chat.R.id.name)).setText(getItem(position).getNick());
			return convertView;
		}
