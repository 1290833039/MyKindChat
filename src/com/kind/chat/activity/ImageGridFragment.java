...
import com.kind.chat.BuildConfig;
import com.kind.chat.domain.VideoEntity;
import com.kind.chat.video.util.ImageCache;
import com.kind.chat.video.util.ImageResizer;
import com.kind.chat.video.util.Utils;
import com.kind.chat.widget.RecyclingImageView;
...
public class ImageGridFragment extends Fragment implements OnItemClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mImageThumbSize = getResources().getDimensionPixelSize(
				com.kind.chat.R.dimen.image_thumbnail_size);
		mImageThumbSpacing = getResources().getDimensionPixelSize(
				com.kind.chat.R.dimen.image_thumbnail_spacing);
		...
		mImageResizer.setLoadingImage(com.kind.chat.R.drawable.empty_photo);
	...
	public View onCreateView(LayoutInflater inflater,
		...
		final View v = inflater.inflate(com.kind.chat.R.layout.image_grid_fragment,
				container, false);
		final GridView mGridView = (GridView) v.findViewById(com.kind.chat.R.id.gridView);
	...
	public void onItemClick(AdapterView<?> parent, View v, final int position, long id) {
		...
		if(position==0)
		{
			...
			if (vEntty.size > 1024 * 1024 * 10) {
				String st = getResources().getString(com.kind.chat.R.string.temporary_does_not);
	...
	private class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup container) {
			 ...
			 if(convertView==null)
			 {
				 ...
				 convertView=LayoutInflater.from(mContext).inflate(com.kind.chat.R.layout.choose_griditem, container,false);
				 holder.imageView=(RecyclingImageView) convertView.findViewById(com.kind.chat.R.id.imageView);
				 holder.icon=(ImageView) convertView.findViewById(com.kind.chat.R.id.video_icon);
				 holder.tvDur=(TextView)convertView.findViewById(com.kind.chat.R.id.chatting_length_iv);
				 holder.tvSize=(TextView)convertView.findViewById(com.kind.chat.R.id.chatting_size_iv);
			...
			String st1 = getResources().getString(com.kind.chat.R.string.Video_footage);
			if(position==0)
			{
				holder.icon.setVisibility(View.GONE);
				holder.tvDur.setVisibility(View.GONE);
				holder.tvSize.setText(st1);
				holder.imageView.setImageResource(com.kind.chat.R.drawable.actionbar_camera_icon);
			}else{
				...
				holder.imageView.setImageResource(com.kind.chat.R.drawable.empty_photo);
