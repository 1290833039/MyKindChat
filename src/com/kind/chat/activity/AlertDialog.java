...
import com.kind.chat.task.DownloadImageTask;
...
public class AlertDialog extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.kind.chat.R.layout.alert_dialog);
		mTextView = (TextView) findViewById(com.kind.chat.R.id.title);
		mButton = (Button) findViewById(com.kind.chat.R.id.btn_cancel);
		imageView = (ImageView) findViewById(com.kind.chat.R.id.image);
		editText = (EditText) findViewById(com.kind.chat.R.id.edit);
		//提示内容
		...
		if(msg != null)
		    ((TextView)findViewById(com.kind.chat.R.id.alert_message)).setText(msg);
		if(title != null)
		...
		if(path != null){
		    ...
		    ((TextView)findViewById(com.kind.chat.R.id.alert_message)).setVisibility(View.GONE);
