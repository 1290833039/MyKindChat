...
import com.kind.chat.adapter.ChatRoomAdapter;
...
public class ChatRoomActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.kind.chat.R.layout.fragment_chatroom);

		instance = this;
		inputMethodManager = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
		roomList = EMChatManager.getInstance().getAllChatRooms();
		chatListView = (ListView) findViewById(com.kind.chat.R.id.list);
