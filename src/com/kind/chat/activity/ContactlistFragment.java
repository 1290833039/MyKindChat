...
public class ContactlistFragment extends Fragment {
				    ...
				    getActivity().runOnUiThread(new Runnable(){
		                ...
		                public void run() {
		                    if(success){
		                        ...
		                        String s1 = getResources().getString(com.kind.chat.R.string.get_failed_please_check);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		return inflater.inflate(com.kind.chat.R.layout.fragment_contact_list, container, false);
	}
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		listView = (ListView) getView().findViewById(com.kind.chat.R.id.list);
		sidebar = (Sidebar) getView().findViewById(com.kind.chat.R.id.sidebar);
		...
		//搜索框
		query = (EditText) getView().findViewById(com.kind.chat.R.id.query);
		query.setHint(com.kind.chat.R.string.search);
		clearSearch = (ImageButton) getView().findViewById(com.kind.chat.R.id.search_clear);
		...
		// 设置adapter
		adapter = new ContactAdapter(getActivity(), com.kind.chat.R.layout.row_contact, contactList);
		...
		ImageView addContactView = (ImageView) getView().findViewById(com.kind.chat.R.id.iv_new_contact);
		// 进入添加好友页
		...
		progressBar = (View) getView().findViewById(com.kind.chat.R.id.progress_bar);
	...
	public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
		...
		if (((AdapterContextMenuInfo) menuInfo).position > 3) {
			...
			getActivity().getMenuInflater().inflate(com.kind.chat.R.menu.context_contact_list, menu);
		}
	}

	@Override
	public boolean onContextItemSelected(MenuItem item) {
		if (item.getItemId() == com.kind.chat.R.id.delete_contact) {
			try {
                // 删除此联系人
			...
			return true;
		}else if(item.getItemId() == com.kind.chat.R.id.add_to_blacklist){
	...
	public void deleteContact(final User tobeDeleteUser) {
		String st1 = getResources().getString(com.kind.chat.R.string.deleting);
		final String st2 = getResources().getString(com.kind.chat.R.string.Delete_failed);
	...
	private void moveToBlacklist(final String username){
		final ProgressDialog pd = new ProgressDialog(getActivity());
		String st1 = getResources().getString(com.kind.chat.R.string.Is_moved_into_blacklist);
		final String st2 = getResources().getString(com.kind.chat.R.string.Move_into_blacklist_success);
		final String st3 = getResources().getString(com.kind.chat.R.string.Move_into_blacklist_failure);
		pd.setMessage(st1);
		pd.setCanceledOnTouchOutside(false);
		pd.show();
		new Thread(new Runnable() {
